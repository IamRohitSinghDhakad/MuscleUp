...
//  MuscleUp
//
//  Created by Rohit Singh Dhakad on 04/07/21.
//
...
class RDIAPHandler: NSObject {
    
    //MARK:- Shared Object
    //MARK:-
    static let shared = RDIAPHandler()
...
//MARK:-
extension RDIAPHandler: SKProductsRequestDelegate, SKPaymentTransactionObserver{
