...
class MessageConstant: NSObject {
    ...
    static let colorGreyBG = UIColor(red: 244.0 / 255.0, green: 244.0 / 255.0, blue: 244.0 / 255.0, alpha: 1.0)
    ...
    static let k_OK: String = "OK"
    static let k_InvalidOTP:String = "Please enter correct OTP number"
